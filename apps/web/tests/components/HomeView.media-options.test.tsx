...
describe("HomeView workbench task chips", () => {
  ...
  it("injects a task-specific system prompt instead of media option controls", async () => {
    ...
    await waitFor(() => {
      ...
      expect(homeHeroPromptText()).toContain("douyin_keyword_unavailable");
      expect(homeHeroPromptText()).toContain("--connector douyin");
      expect(homeHeroPromptText()).toContain("抖音关键词候选预览请求");
