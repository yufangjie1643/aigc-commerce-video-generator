...
export const en: Dict = {
  ...
  "chat.amrCard.switchBody":
    "Switch to Open Design's official AMR model service — no API key setup needed. After you sign in, authorize, and top up, this run retries automatically.",
  ...
  "chat.amrError.authMessage":
    "Your AMR account isn't authorized yet. Authorize it and this run retries automatically.",
  ...
  "settings.testInvalidModelId":
    "Model id '{model}' is invalid. Custom ids must start with a letter or number and contain no spaces.",
  ...
  "settings.byokVideoI2vHint":
    "Image-to-video model: a reference image is required (the newest project image is used automatically if you don’t pick one)",
  ...
  "settings.mediaProviders": "Media generation API",
  "settings.mediaProvidersHint":
    "API keys for image, video, and audio generation. Media understanding lives on its own page.",
  "settings.understandingApi": "Media understanding API",
  ...
  "settings.understandingApiProviderTitle": "Understanding providers",
  ...
  "settings.mediaProviderComingSoonHint":
    "We track these for the roadmap; the daemon doesn't ship a client yet, so there's nothing to configure.",
  ...
  "settings.privacyConsentFooter":
    "You can change either of these any time in Settings → Privacy. We never upload the contents of your generated artifact files.",
  ...
  "settings.privacyContentHint":
    "Your prompts, assistant responses, tool inputs, and tool outputs (truncated before send). API keys, tokens, JWTs, emails, IPs, and credit-card numbers are stripped automatically before send.",
  ...
  "settings.privacyDataDeletionHint":
    "Rotates your anonymous ID and stops sending. Existing traces age out under our retention policy.",
  ...
  "homeHero.footer.autoDesignSystemSummary":
    "Automatically matches the best design system and visual style for the current prompt.",
  ...
  "handoff.promptReadFiles":
    "Enter or read this directory first. Prioritize DESIGN.md, README, existing HTML/CSS/JS, assets, and package.json if present.",
  "handoff.promptKeepDesign":
    "Preserve the current visual design, layout, interactions, and assets. Do not stop at a plan.",
  "handoff.promptProduceCode":
    "Generate or modify real runnable {framework} code. If the project already has a clearer stack, call out the conflict and keep the result runnable.",
  ...
  "pluginsView.lede":
    "Browse installed workflows, discover registry entries, manage sources, and prepare plugins for team distribution.",
  ...
  "pluginsView.availableEmptyInstalled":
    "No available entries yet. Installed catalog entries are removed from Available; uninstall one to make it available again.",
  ...
  "integrations.lede":
    "Connect external systems, bring MCP tools into your agent loop, and use Open Design from other IDEs, scripts, and automations.",
  ...
  "integrations.skillsBody":
    "Skill-level integration management is being carried over from another branch. This tab is reserved so MCP, Connectors, and future Skills setup live in the same Integration route.",
  ...
  "mcpClient.emptyBody":
    'Click "Add server" to get started — pick a template (Higgsfield OpenClaw, Pollinations, Allyson, Imagician, EdgeOne Pages, GitHub, Filesystem…) or set up a custom stdio / HTTP server.',
  ...
  "useEverywhere.modalTitle": "WeChat Agent connection",
  "useEverywhere.modalSubtitle":
    "Connect WeChat to an internal Agent, then ask about scheduled agent sessions, automations, Orbit summaries, and live dashboard status.",
  ...
  "useEverywhere.footStrong": "WeChat status entry.",
  "useEverywhere.footBody":
    "The fallback brief is only for wiring a WeChat gateway to the Open Design internal Agent bridge; the old Use Everywhere guide is no longer shown here.",
  "useEverywhere.configureMcp": "Open automations",
  "useEverywhere.copyGuide": "Copy fallback setup",
  ...
  "useEverywhere.section.overview.heading": "Connect WeChat to an internal Agent",
  "useEverywhere.section.overview.intro":
    "Connect a WeChat entry to an Open Design internal Agent such as OpenCode, then ask Open Design automation status from chat.",
  "useEverywhere.section.overview.bullet1":
    "Reuse Open Design's existing Agent connections first; no extra channel CLI is required.",
  "useEverywhere.section.overview.bullet2": "Automation run status",
  "useEverywhere.section.overview.bullet3": "Orbit summary progress",
  "useEverywhere.section.overview.bullet4": "Live dashboard freshness",
  ...
  "useEverywhere.section.overview.snippet1": "Connect the internal Agent bridge",
  ...
  "useEverywhere.section.overview.footer":
    "Open Design does not store WeChat credentials. The WeChat gateway owns WeChat auth; Open Design only exposes an internal Agent bridge and read-only status surfaces.",
  ...
  "useEverywhere.section.cli.intro":
    "The `od` bin ships with the daemon and is the same binary used by Claude Code / Codex when they run a generation. Most subcommands are thin clients that POST to the local daemon, so they work the same whether you launched it via `pnpm tools-dev` or as a packaged app.",
  ...
  "useEverywhere.section.cli.footer":
    "All subcommands accept `--daemon-url http://127.0.0.1:<port>` to target a specific running daemon — useful when running a sandboxed second instance for tests.",
  ...
  "useEverywhere.section.mcp.intro":
    "Open Design ships with a Model Context Protocol server (`od mcp`) that lets any MCP-capable client — Cursor, Claude Code, Antigravity, VS Code Copilot Chat, openclaw, hermes — discover Open Design tools (list skills, render previews, generate media, run plugins) without shelling out manually. The daemon publishes a ready-to-paste install snippet via `GET /api/mcp/install-info` for each major client.",
  ...
  "useEverywhere.section.mcp.footer":
    "In the Open Design app, open Settings → Integrations to copy a client-specific install command (Cursor, Claude Code, Antigravity, VS Code) instead of editing JSON by hand.",
  ...
  "useEverywhere.section.http.intro":
    "The local daemon serves an HTTP API at `http://127.0.0.1:7456` (port configurable). Every endpoint the web UI calls is also fair game for your scripts. Streaming endpoints (chat turns, project runs) emit Server-Sent Events with the contract types in `@open-design/contracts`.",
  ...
  "useEverywhere.section.http.footer":
    "Pure TypeScript types for every request/response live in `@open-design/contracts` — import them in your script for full autocomplete without wiring a generator.",
  ...
  "useEverywhere.section.skills.footer":
    "Spec: `docs/skills-protocol.md` and `docs/agent-adapters.md` cover the full adapter surface (Claude Code, Codex, Cursor, MCP-capable agents, BYOK API fallback) and the per-adapter skill injection strategies.",
  "tasks.kicker": "Automation workspace",
  "tasks.comingSoon": "Coming soon",
  "tasks.lede":
    "Automations turn prompts into durable work: Orbit runs them, routines keep them around, schedules decide when they fire, and live artifacts show what changed.",
  "tasks.newAutomation": "New automation",
  "tasks.previewNote":
    "Preview surface only. Orbit settings are available today; routines, schedules, and live artifact wiring will land as the backend branches merge.",
  ...
  "promptTemplates.attributionFooter":
    "Adapted from public prompt libraries. Each card links back to the original author.",
  ...
  "chat.mode.chat.summary":
    "For quick answers, edits, planning, and discussion without assuming a design artifact must be created.",
  "chat.mode.chat.solves":
    "Use it to clarify ideas, debug prompts, compare options, or ask questions about existing work.",
  ...
  "chat.mode.design.summary":
    "For creating or changing concrete outputs: pages, prototypes, live artifacts, slides, images, videos, HyperFrames, audio, dashboards, and project files.",
  "chat.mode.design.solves":
    "Use it when you want Open Design to generate files, update the workspace, or turn a brief into multimodal deliverables.",
  ...
  "browserUse.summary":
    "{count} web actions, prioritizing asset extraction, design language, motion, visual checks, and component structure.",
  ...
  "browserUse.action.extract_logo.output":
    "Best logo candidates from header, nav, class names, position, OG image, and favicon fallback.",
  "browserUse.action.list_images.output":
    "All img, srcset, source, and CSS background images with dimensions and alt text.",
  "browserUse.action.download_assets.output":
    "Downloaded asset folder plus _manifest.json with referer and cookie support.",
  ...
  "browserUse.action.extract_colors.output":
    "Weighted palette plus :root CSS color variables as palette.json and palette.html.",
  "browserUse.action.extract_fonts.output":
    "Top font families, sizes, weights, and @font-face rules as typography.json.",
  ...
  "browserUse.action.extract_type_scale.output":
    "Heading, body, and button type scale with size, weight, line-height, and ratios.",
  ...
  "browserUse.action.extract_grid_system.output":
    "Grid and flex containers, direction, gaps, columns, and max widths as layout.json.",
  ...
  "browserUse.action.extract_shadows.output":
    "Box shadows, text shadows, and drop shadows as shadows.json plus preview.",
  ...
  "browserUse.action.export_tokens.output":
    "tokens.css, tokens.scss, tailwind.theme.js, and style-dictionary.tokens.json.",
  "browserUse.action.extract_animations.output":
    "@keyframes, transition and transform rules, detected motion libraries, motion.css, and motion.json.",
  ...
  "browserUse.action.audit_layout.output":
    "Layout defects including overflow, bounds, overlap, and clipped text as audit.json.",
  "browserUse.action.audit_accessibility.output":
    "A11y issues with selectors, labels, roles, focus, contrast, and screenshots where useful.",
  ...
  "browserUse.action.extract_html.output":
    "Clean self-contained HTML without script, noscript, or inline event attributes.",
  "browserUse.action.extract_component_inventory.output":
    "Repeated component patterns, selectors, counts, and screenshots.",
  ...
  "browserUse.action.snapshot.output":
    "Up to 120 visible interactive and text elements with tag, label, href, and coordinates.",
  ...
  "browserUse.action.extract_og_metadata.output":
    "Meta title, description, canonical URL, OG/Twitter cards, social image, and theme color.",
  ...
  "chat.designToolbox.action.auto-match.description":
    "Define the taste bar first, then match skills, MCP, plugins, connectors, and files.",
  ...
  "chat.designToolbox.action.motion.description":
    "Add entrance, scroll, state-transition, and micro-interaction motion to the current HTML or page element.",
  ...
  "chat.designToolbox.action.motion-polish.description":
    "Review timing, easing, performance, and reduced-motion fallbacks for existing motion.",
  ...
  "chat.designToolbox.action.anti-ai-polish.description":
    "Remove template feel, AI gradients, cheap card stacks, and vague copy.",
  ...
  "chat.designToolbox.action.visual-polish.description":
    "Audit visual hierarchy, type, spacing, responsive behavior, accessibility, and delivery quality.",
  ...
  "chat.designToolbox.action.image-gen.description":
    "Generate section references, assets, icons, social images, or a moodboard for the current page.",
  ...
  "chat.designToolbox.action.video-gen.description":
    "Turn the design into a short video, Remotion / Hyperframes storyboard, or generation-ready prompt.",
  ...
  "chat.designToolbox.prompt.noSkill":
    "If no specific skill matched, first choose the best combination from available skills, MCP, plugins, connectors, and design files.",
  "chat.designToolbox.prompt.autoMatchIntro":
    "Act as the Creative Director orchestrator and complete a design workflow:",
  "chat.designToolbox.prompt.autoMatchStep1":
    "1. Define what “good-looking design” means first: audience, business goal, brand feel, style references, information density, color/type/motion/asset standards, and AI/template patterns to avoid.",
  "chat.designToolbox.prompt.autoMatchStep2":
    "2. Search and match the full resource index above. Do not only use design toolbox recommendations; combine skills, MCP, plugins, connectors, and design files when useful.",
  "chat.designToolbox.prompt.autoMatchStep3":
    "3. If the target or aesthetic bar is still unclear, guide me with finite choices or a form-style UI and include a recommended default. If it is clear enough, execute the next step directly.",
  "chat.designToolbox.prompt.autoMatchStep4":
    "4. Complete the flow in this order: diagnose -> style direction -> resource selection -> concrete edit/generation -> verification. At each step, explain why these resources were chosen and what needs confirmation next.",
  "chat.designToolbox.prompt.motion":
    "Add high-quality motion to the current HTML / page element: choose the most useful 1-2 entrance, scroll, state-transition, or micro-interaction moments. Keep it restrained, prefer transform / opacity, and include prefers-reduced-motion fallbacks.",
  "chat.designToolbox.prompt.motionPolish":
    "Review and polish existing motion timing, easing, performance, and accessibility. Remove abrupt, cheap, or readability-harming animation; use a more refined timeline when needed.",
  "chat.designToolbox.prompt.antiAiPolish":
    "Do one anti-AI-feel polish pass: remove templated layouts, cheap gradients/glows, meaningless card stacks, and vague copy. Preserve information and make it feel like a real designer delivered it.",
  ...
  "chat.designToolbox.prompt.imageGen":
    "Create the next visual-asset plan for this design: section references, hero assets, illustrations, icons, social images, or a moodboard. First decide what kind of image is missing, then provide executable generation prompts / file plan.",
  "chat.designToolbox.prompt.videoGen":
    "Turn this design toward video: create a short-video storyboard, Hyperframes / Remotion frame structure, or Sora/fal-ready prompt. Prefer making the existing HTML / page content naturally become shots.",
  "chat.designToolbox.prompt.useSkill": "Use {skill} on the current design.",
  "chat.designToolbox.prompt.skillInstruction":
    "First decide the best follow-up goal, then complete one concrete pass. If it depends on external assets or APIs, provide a runnable fallback or state what I need to provide.",
  ...
  "chat.designToolbox.prompt.pluginResource":
    "Use this plugin as the main context for the current design flow. If it exposes inputs or GenUI, guide me to choose when needed; if it does not fit the target, choose a better global resource and explain why.",
  "chat.designToolbox.prompt.mcpResource":
    "Prefer this MCP capability for the next design step. When external assets, web capture, image/video generation, or data are needed, first decide whether it can do the job, then give an executable plan.",
  "chat.designToolbox.prompt.mcpTemplateResource":
    "This MCP is a configurable template. If it is the most useful tool for this design step, guide setup first; if a configured alternative exists, continue with that alternative.",
  "chat.designToolbox.prompt.connectorResource":
    "Use this connector when real data, assets, account content, or external workflow access is needed. Before using it, explain what will be read or written and ask for confirmation when appropriate.",
  "chat.designToolbox.prompt.fileResource":
    "Use this design file as the current design target or reference asset and complete the next step from it. If other files need comparison, continue searching across all design files.",
  "chat.designToolbox.prompt.resourceIndex":
    "Global resource index: skills({skills}), plugins({plugins}), MCP({mcpEnabled} enabled / {mcpTemplates} templates), connectors({connectors} connected), design files({files}).",
  ...
  "chat.designToolbox.prompt.processRule":
    "Workflow rule: define the aesthetic goal and constraints first, then search and match resources; when user choice is needed, generate a finite-choice UI and continue after confirmation.",
  ...
  "chat.example1Title": "Upload product assets",
  "chat.example1Tag": "Asset prep",
  "chat.example1Prompt":
    "Next step: use the product images / videos I provide to identify the category, core selling points, target shopper, and asset quality, then draft a 15-second AIGC shoppable video plan with shot structure, hook, voiceover direction, pacing, and missing assets.",
  "chat.example2Title": "Generate sales scripts",
  "chat.example2Tag": "Selling points",
  "chat.example2Prompt":
    "Next step: create 3 short-video commerce scripts for this product, each 15-30 seconds. Structure each as a pain-point hook, benefit proof, use scenario, offer cue, and CTA, with visual prompts, voiceover copy, and subtitle rhythm.",
  "chat.example3Title": "Batch produce videos",
  "chat.example3Tag": "Asset library",
  "chat.example3Prompt":
    "Next step: turn the existing product assets into a batch AIGC video production task list. For each item, include source assets, selling-point clips, voiceover script, cover title, slicing strategy, library tags, priority, and missing info.",
  ...
  "fileViewer.cloudflareApiTokenReuseHint":
    "The saved Cloudflare API token will be used. Enter a new token to replace it.",
  "fileViewer.cloudflareApiTokenRequired": "Enter and save a Cloudflare API token first.",
  "fileViewer.cloudflareApiTokenScopeHint":
    "Select Pages Edit when creating the API token; custom domains need Zone Read / DNS Edit.",
  ...
  "fileViewer.cloudflareCustomDomainHint":
    "Optional: bind a custom domain. Leaving this blank still creates a pages.dev link.",
  ...
  "pet.builtInEmpty":
    "Built-in pets are unavailable right now. Try refreshing the Community tab once the daemon is online.",
  ...
  "pet.atlasPickerHint":
    "Codex pets ship 9 animation rows. By default we keep the full atlas so the pet swaps rows on hover, drag, and idle. You can also freeze it to a single loop.",
  ...
  "pet.hatchHint":
    "Use the bundled hatch-pet skill in chat to generate a Codex-style spritesheet, then import it here.",
  ...
  "settings.notifyTestSent":
    "Test notification sent. If no banner appears, check browser and system notification settings.",
  ...
  "settings.projectLocationsDescription":
    "Add work bases that can contain multiple Open Design project folders. New projects are saved as one folder inside the selected base.",
  "settings.projectLocationsSaveError":
    "Could not save project locations. Check that each path is an accessible folder.",
  ...
  "settings.connectorsClearConfirmBody":
    "Removing the key disconnects every Composio connector linked to this workspace. Connected accounts, OAuth grants, and tool access will all be removed.",
  ...
  "settings.connectorsClearFinalBody":
    "There is no undo. You will need to reconnect each integration from scratch after pasting a new key.",
  ...
  "settings.connectorsHelpSaved":
    "Your key is saved in the local daemon. Paste a new key to replace it, or Clear to remove.",
  "settings.connectorsHelpUnsaved":
    "Unsaved changes \u2014 click Save key to store this credential in the local daemon and refresh the catalog below.",
  ...
  "settings.customInstructionsHint":
    "Fixed instructions OpenDesign should follow in every chat. Save facts, preferences, and project context as memories.",
  "settings.customInstructionsPlaceholder":
    'e.g. "Always use TypeScript. Prefer functional components. Keep responses concise."',
  ...
  "settings.memoryBodyHint":
    "Bullet the rules first, then optional Why and When-to-apply lines. Markdown supported. Or click a starter above to load a working example.",
  ...
  "settings.orbit.lede":
    "Collect connector activity on a schedule and publish the result as a refreshable live artifact.",
  ...
  "settings.orbit.templateHelp":
    "Steer Orbit with a skill — the selected template example prompt is injected into every Orbit run so summaries follow that template shape.",
  ...
  "settings.orbit.runError":
    "Could not run Orbit. Make sure the local daemon is running and connectors are configured.",
  ...
  "settings.orbit.gateBody":
    "Orbit summarizes activity across your connectors. You haven\u2019t connected anything yet \u2014 add at least one integration to give Orbit something to report on.",
  "settings.orbit.gateBodyNoKey":
    "Orbit summarizes activity across your connectors, and connectors run through Composio. Add a Composio API key in Connectors to load the catalog and pick your first integration.",
  ...
  "settings.orbit.artifactMetaLegacy":
    "Generated before live artifact support was enabled — run Orbit again to publish one.",
  ...
  "updater.quitFailedBody":
    "The installer is open, but Open Design could not quit. Quit Open Design before replacing the app.",
  ...
  "settings.memoryModelInlineHintCli":
    "Optional. Uses the selected Local CLI when supported; choose a model only to override the default.",
  "settings.memoryModelInlineHintCliConstrained":
    "Optional. Uses the selected Local CLI when supported; {provider} is only the fallback provider family.",
  ...
  "settings.customInstructionsDesc":
    "Fixed instructions Open Design follows in every chat. These are not saved memories; use Memory for facts, preferences, and project context.",
  "mcpClient.forwardedToLabel": "Forwarded to:",
  "mcpClient.notForwardedToLabel": "Not forwarded to:",
  "mcpClient.forwardedAcpNote":
    "ACP adapters marked stdio only receive stdio MCP servers from this list; HTTP and SSE entries are dropped at spawn time.",
  "mcpClient.notForwardedNote":
    "For those agents, configure MCP servers in the agent's own config file (e.g. ~/.codex/config.toml, ~/.gemini/settings.json); the servers below are silently unused there."
};
