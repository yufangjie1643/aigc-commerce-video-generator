...
export const zhTW: Dict = {
  ...
  "settings.understandingApiProviderHint": "小米 MiMo 覆蓋圖片、音訊、影片理解；火山 Ark 保留原生 video_url 影片理解。",
  "settings.understandingApiImageModel": "圖片理解模型 / Endpoint",
  ...
  "settings.understandingApiAudioModel": "音訊理解模型 / Endpoint",
  ...
  "settings.mediaProviderVideoUnderstandingModel": "影片理解模型 / Endpoint",
  "settings.mediaProviderVideoUnderstandingModelPlaceholder": "{defaultModel}",
  "settings.mediaProviderVideoUnderstandingHint":
    "Agent 和 CLI 的原生 video_url 影片理解會使用這裡。火山 Ark 帳號仍可在這裡填 ep-... endpoint。",
