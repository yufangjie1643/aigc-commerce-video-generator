...
export const zhTW: Dict = {
  ...
  "settings.mediaProviders": "媒體生成 API",
  "settings.mediaProvidersHint": "圖片、影片、音訊生成的 API key。媒體理解已單獨放到「媒體理解 API」。",
  "settings.understandingApi": "媒體理解 API",
  "settings.understandingApiHint": "集中配置給 agent 和 CLI 使用的原生圖片、音訊、影片理解能力。",
  "settings.understandingApiNavSub": "圖片 / 音訊 / 影片",
  "settings.understandingApiProviderTitle": "理解 API 提供商",
  "settings.understandingApiProviderHint":
    "小米 MiMo 覆蓋圖片、音訊、影片理解；火山 Ark 只開放白名單模型的原生 video_url 影片理解。",
  "settings.understandingApiImageModel": "圖片理解模型",
  "settings.understandingApiImageModelPlaceholder": "{defaultModel}",
  "settings.understandingApiImageModelHint": "Agent 和 CLI 的原生 image_url 圖片理解會使用這裡。",
  "settings.understandingApiAudioModel": "音訊理解模型",
  "settings.understandingApiAudioModelPlaceholder": "{defaultModel}",
  "settings.understandingApiAudioModelHint": "Agent 和 CLI 的原生 input_audio 音訊理解會使用這裡。",
  ...
  "settings.mediaProviderVideoUnderstandingModel": "影片理解模型",
  "settings.mediaProviderVideoUnderstandingModelPlaceholder": "{defaultModel}",
  "settings.mediaProviderVideoUnderstandingHint":
    "Agent 和 CLI 的原生 video_url 影片理解會使用這裡。火山 Ark 僅允許 doubao-seed-2-0-lite-260215；ep-* endpoint 屬於單獨的火山生成/文字輸出提供商。",
  ...
  "settings.privacyContentHint":
    "你送出的 prompt 與助理的回覆(分別截斷至 8 KB / 16 KB)。API key、token、JWT、信箱、IP 與信用卡號會在傳送前自動剝離。",
  ...
  "entry.useEverywhereTitle": "微信連線",
  "entry.useEverywhereAria": "開啟微信自動化狀態連線",
  ...
  "integrations.tabHint.useEverywhere": "微信狀態",
  ...
  "useEverywhere.modalAria": "連接微信自動化狀態",
  "useEverywhere.modalTitle": "微信 Agent 連接",
  "useEverywhere.modalSubtitle":
    "連接微信到內置 Agent 後，可在微信詢問定時智慧體會話、自動化、Orbit 摘要和即時看板狀態。",
  "useEverywhere.closeAria": "關閉微信連線",
  "useEverywhere.closeTitle": "關閉 (Esc)",
  "useEverywhere.tabsAria": "微信狀態入口",
  "useEverywhere.footStrong": "微信狀態入口。",
  "useEverywhere.footBody": "備用說明只用於把微信閘道接入 Open Design 內置 Agent 橋，不再展示舊的隨處使用指南。",
  "useEverywhere.configureMcp": "查看自動化",
  "useEverywhere.copyGuide": "複製備用接入說明",
  "useEverywhere.copy": "複製",
  "useEverywhere.copied": "已複製",
  "useEverywhere.copyFailed": "複製失敗",
  "useEverywhere.copySnippetAria": "複製程式碼片段：{label}",
  "useEverywhere.section.overview.tab": "微信",
  "useEverywhere.section.overview.heading": "連接微信到內置 Agent",
  "useEverywhere.section.overview.intro":
    "把微信入口接到 Open Design 已連接的內置 Agent（如 OpenCode）後，就能在聊天裡詢問 Open Design 自動化狀態。",
  "useEverywhere.section.overview.bullet1": "優先複用 Open Design 已連接的 Agent，不要求使用者額外安裝外部通道 CLI。",
  "useEverywhere.section.overview.bullet2": "自動化執行狀態",
  "useEverywhere.section.overview.bullet3": "Orbit 摘要進度",
  "useEverywhere.section.overview.bullet4": "即時看板新鮮度",
  "useEverywhere.section.overview.bullet5": "先把微信保持為唯讀狀態入口；橋接可信後，再逐步加入觸發控制。",
  "useEverywhere.section.overview.snippet1": "連接內置 Agent 橋",
  "useEverywhere.section.overview.snippet2": "Open Design 狀態讀取入口",
  "useEverywhere.section.overview.snippet3": "微信問題和回覆結構",
  "useEverywhere.section.overview.footer":
    "Open Design 不會保存微信憑據。微信認證由閘道負責；Open Design 這裡只暴露內置 Agent 橋和唯讀狀態入口。",
  ...
  "chat.mode.comprehensive.label": "綜合",
  "chat.mode.comprehensive.title": "綜合工作台模式",
  "chat.mode.comprehensive.summary": "適合由 agent 串聯影片爬取、素材庫分析、腳本分鏡、媒體生成和診斷復盤的完整任務。",
  "chat.mode.comprehensive.solves":
    "當任務需要 agent 自行判斷該用哪些後端介面、連接器和 skill，而不是進入單一問答或設計簡報時使用。",
  "chat.mode.comprehensive.query1": "爬取公開影片樣本，篩選後只把有價值的帶貨參考加入素材庫。",
  "chat.mode.comprehensive.query2": "解析目前影片素材，提取可複用的分鏡結構和方法論。",
  "chat.mode.comprehensive.query3": "基於素材、腳本、分鏡和質檢門檻生成一條產品影片流水線。",
  ...
  "chat.example1Title": "上傳商品素材",
  "chat.example1Tag": "素材準備",
  "chat.example1Prompt":
    "下一步：請基於我提供的商品圖片 / 影片，先識別商品品類、核心賣點、適合人群和素材品質，並輸出一份 15 秒 AIGC 帶貨影片生成方案。包含鏡頭結構、開場鉤子、口播方向、畫面節奏和需要補充的素材清單。",
  "chat.example2Title": "生成帶貨腳本",
  "chat.example2Tag": "賣點腳本",
  "chat.example2Prompt":
    "下一步：為這款商品生成 3 條適合短影音平台的帶貨腳本，每條 15-30 秒。請按痛點開場、賣點證明、使用場景、優惠引導和行動召喚組織，並給出畫面提示詞、口播文案和字幕節奏。",
  "chat.example3Title": "批量產出影片",
  "chat.example3Tag": "成片入庫",
  "chat.example3Prompt":
    "下一步：根據已有商品素材批量生成 AIGC 帶貨影片任務清單。請把每個商品拆成主圖素材、賣點短片、口播腳本、封面標題、切片策略和入庫標籤，並標註優先級與缺失資訊。",
  ...
  "automations.tpl.videoAssetCrawler.title": "爬影片入素材庫",
  "automations.tpl.videoAssetCrawler.desc":
    "搜尋帶貨影片候選，篩選可用參考影片，匯入 commerce video 素材庫並驗證入庫結果。",
  "automations.tpl.videoAssetCrawler.prompt":
    "圍繞指定商品、類目、平台或關鍵詞，使用可用影片搜尋/爬蟲連接器尋找公開帶貨影片候選。先由 agent 判斷哪些影片真正適合做參考素材，再把入選影片加入 commerce video 素材庫。優先使用後端素材庫 CLI：`od assets commerce-videos search --connector bilibili --query <關鍵詞> --limit 20 --sort hot --json`；逐條篩選後用 `od assets commerce-videos import --title <標題> --connector bilibili --source-url <url> --source-video-id <平台影片 id> --subject <商品或關鍵詞> --category 帶貨視頻樣本 --summary <選擇理由> --json` 寫入素材庫；需要立即下載影片檔案時使用 `od assets commerce-videos import-crawler --connector bilibili --url <url> --json`，本地公開 Bilibili 測試路徑可追加 `--public-test --resolution 360p`。匯入後用 `od assets commerce-videos list --query <關鍵詞> --json` 驗證，並輸出已匯入素材 ID、跳過原因和連接器/授權缺口。",
