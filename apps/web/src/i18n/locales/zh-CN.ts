...
export const zhCN: Dict = {
  ...
  "settings.understandingApiProviderHint": "小米 MiMo 覆盖图片、音频、视频理解；火山 Ark 保留原生 video_url 视频理解。",
  "settings.understandingApiImageModel": "图片理解模型 / Endpoint",
  ...
  "settings.understandingApiAudioModel": "音频理解模型 / Endpoint",
  ...
  "settings.mediaProviderVideoUnderstandingModel": "视频理解模型 / Endpoint",
  "settings.mediaProviderVideoUnderstandingModelPlaceholder": "{defaultModel}",
  "settings.mediaProviderVideoUnderstandingHint":
    "Agent 和 CLI 的原生 video_url 视频理解会使用这里。火山 Ark 账号仍可在这里填 ep-... endpoint。",
