...
export const zhCN: Dict = {
  ...
  "app.brand": "带货视频工作台",
  "app.brandPill": "AIGC 工作台",
  "app.brandSubtitle": "商品到视频工作流",
  ...
  "homeHero.title": "开始生成带货视频",
  "homeHero.templatesScrollHint": "向下探索电商视频模板",
  "homeHero.templatesCollapse": "收起模板",
  "homeHero.subtitlePrefix": "项目、素材、剧本、创作、生成/诊断集中在一个工作台。",
  "homeHero.placeholder": "粘贴商品信息、上传素材，或描述你要生成的带货视频…",
  "homeHero.placeholderActive": "编辑这条带货视频示例，或写下你自己的需求…",
  "homeHero.skills": "技能",
  "homeHero.addMenu": "添加",
  ...
  "homeHero.chip.templateHint": "浏览电商视频剧本、分镜、平台预设和参考视频拆解模板。",
  ...
  "pluginsHome.title": "电商视频模板库",
  "pluginsHome.subtitle": "商品带货视频的剧本、分镜、平台规格、参考拆解与渲染预设。",
  "pluginsHome.browseRegistry": "打开模板市场",
  "pluginsHome.count": "{filtered} / {total}",
  "pluginsHome.loadingCatalog": "正在加载模板…",
  "pluginsHome.emptyCatalog": "暂时没有可用的电商视频模板。媒体生成底座已保留，下一步可以继续接入模板包。",
  ...
  "pluginsHome.searchPlaceholder": "搜索视频模板…",
  "pluginsHome.searchAria": "搜索电商视频模板",
  ...
  "useEverywhere.modalSubtitle": "连接微信到内置 Agent 后，可在微信里询问定时智能体会话、自动化、Orbit 摘要和实时看板状态。",
  ...
  "automations.eyebrow": "视频工作流自动化",
  "automations.title": "视频自动化",
  "automations.lede": "为带货视频素材、剧本、分镜、生成诊断和效果复盘安排周期性会话。",
  ...
  "automations.templatesSub": "只保留带货视频生产会用到的周期任务：素材、剧本、分镜、生成诊断和效果复盘。",
