...
export const zhCN: Dict = {
  ...
  "app.brand": "综合工作台",
  "app.brandPill": "AIGC 综合工作台",
  "app.brandSubtitle": "数据、素材、脚本、生成一体化",
  "app.welcomeLoading": "正在加载工作区…",
  "settings.welcomeKicker": "",
  "settings.welcomeTitle": "欢迎",
  "settings.welcomeSubtitle": "",
  "settings.onboardingCreateTitle": "从商品信息开始",
  "settings.onboardingCreateBody": "描述商品、上传素材，或粘贴带货 brief。工作台会创建一个可继续编辑的电商视频项目。",
  ...
  "settings.onboardingDesignIntroGenerateTitle": "准备商品素材",
  "settings.onboardingDesignIntroGenerateBody": "上传商品图、参考视频、脚本、品牌说明或平台要求，用来启动视频工作流。",
  "settings.onboardingDesignIntroReuseTitle": "后续视频直接复用",
  "settings.onboardingDesignIntroReuseBody": "后续商品视频可以复用同一套素材风格、字幕语气、平台规格和品牌动效选择。",
  "settings.onboardingDesignIntroSkipTitle": "也可以先跳过",
  "settings.onboardingDesignIntroSkipBody": "现在也可以先跳过，直接从空白带货视频项目开始。",
  ...
  "settings.onboardingUseProduct": "🎬 电商带货视频",
  "settings.onboardingUseDesignSystem": "🧩 品牌 / 风格预设",
  "settings.onboardingUsePrototype": "🧾 剧本与分镜",
  "settings.onboardingUseLanding": "🛍️ 商品素材整理",
  "settings.onboardingUseAds": "📣 平台广告 / 社媒短视频",
  "settings.onboardingUseDashboard": "📊 生成诊断",
  "settings.onboardingUseDeck": "🎞️ 参考视频拆解",
  "settings.onboardingUseMarketing": "📈 转化优化",
  "settings.onboardingUseEngineering": "🤝 团队生产交付",
  "settings.onboardingUseAgency": "💼 客户视频制作",
  ...
  "settings.mediaProviders": "媒体生成 API",
  "settings.mediaProvidersHint": "图片、视频、音频生成的 API key。媒体理解已单独放到「媒体理解 API」。",
  "settings.understandingApi": "媒体理解 API",
  "settings.understandingApiHint": "集中配置给 agent 和 CLI 使用的原生图片、音频、视频理解能力。",
  "settings.understandingApiNavSub": "图片 / 音频 / 视频",
  "settings.understandingApiProviderTitle": "理解 API 提供商",
  "settings.understandingApiProviderHint":
    "小米 MiMo 覆盖图片、音频、视频理解；火山 Ark 只开放白名单模型的原生 video_url 视频理解。",
  "settings.understandingApiImageModel": "图片理解模型",
  "settings.understandingApiImageModelPlaceholder": "{defaultModel}",
  "settings.understandingApiImageModelHint": "Agent 和 CLI 的原生 image_url 图片理解会使用这里。",
  "settings.understandingApiAudioModel": "音频理解模型",
  "settings.understandingApiAudioModelPlaceholder": "{defaultModel}",
  "settings.understandingApiAudioModelHint": "Agent 和 CLI 的原生 input_audio 音频理解会使用这里。",
  ...
  "settings.mediaProviderModelPlaceholder": "覆盖默认模型 ID",
  "settings.mediaProviderVideoUnderstandingModel": "视频理解模型",
  "settings.mediaProviderVideoUnderstandingModelPlaceholder": "{defaultModel}",
  "settings.mediaProviderVideoUnderstandingHint":
    "Agent 和 CLI 的原生 video_url 视频理解会使用这里。火山 Ark 仅允许 doubao-seed-2-0-lite-260215；ep-* endpoint 属于单独的火山生成/文本输出提供商。",
  "settings.mediaProviderReload": "从本地守护进程重新加载",
  "settings.mediaProviderReloaded": "已重新加载",
  ...
  "settings.mediaProviderWorkflowTitle": "视频工作台 API 能力",
  "settings.mediaProviderWorkflowHint": "按电商视频流程管理模型能力：商品素材、脚本、首帧、视频、口播、音效与分析。",
  "settings.mediaProviderWorkflowConfiguredCount": "已配置 {count}/{total}",
  "settings.mediaProviderWorkflowRequired": "必需",
  "settings.mediaProviderWorkflowOptional": "可选",
  "settings.mediaProviderWorkflowNoModels": "无固定模型",
  "settings.mediaProviderWorkflowNoAvailableModels": "暂无可用模型，请先配置对应 API key",
  "settings.mediaProviderWorkflowGroupConfigured": "本组已配置 {count}/{total}",
  "settings.mediaWorkflowVideoTitle": "视频生成",
  "settings.mediaWorkflowVideoHint": "文生视频、图生视频、商品宣传片和参考视频复刻。",
  "settings.mediaWorkflowImageTitle": "商品图与首帧",
  "settings.mediaWorkflowImageHint": "商品主图优化、场景图、封面图和视频首帧。",
  "settings.mediaWorkflowVoiceTitle": "口播配音",
  "settings.mediaWorkflowVoiceHint": "中文带货旁白、卖点解说、多音色 TTS 与声音克隆。",
  "settings.mediaWorkflowSoundTitle": "音效与音乐",
  "settings.mediaWorkflowSoundHint": "转场音效、环境声和背景音乐，首期可先不开。",
  "settings.mediaWorkflowResearchTitle": "参考分析",
  "settings.mediaWorkflowResearchHint": "检索竞品、爆款结构、平台趋势和参考视频素材。",
  "settings.mediaProviderManageTitle": "API key 与模型管理",
  "settings.mediaProviderManageHint": "粘贴 key、调整 Base URL 或覆盖模型 ID；保存后会同步到本地守护进程。",
  "settings.mediaProviderModelsLabel": "模型",
  "settings.mediaProviderTest": "验证",
  "settings.mediaProviderTestRetry": "重新验证",
  "settings.mediaProviderTestRunning": "正在验证…",
  "settings.mediaProviderTestTitle": "验证此媒体生成 API 是否可用",
  "settings.mediaProviderTestSuccess": "验证通过，用时 {ms}ms。",
  "settings.mediaProviderTestSuccessWithModels": "验证通过，用时 {ms}ms，发现 {count} 个模型。",
  "settings.mediaProviderTestMissingKey": "缺少 API key。请先粘贴 key 或保存已有配置。",
  "settings.mediaProviderTestAuthFailed": "鉴权失败。请检查 API key 是否正确、是否有权限。",
  "settings.mediaProviderTestForbidden": "请求被拒绝。请检查账号权限、地区或 Base URL。",
  "settings.mediaProviderTestInvalidBaseUrl": "Base URL 无效或指向了被禁止的地址。",
  "settings.mediaProviderTestRateLimited": "接口已限流。稍后再试或检查额度。",
  "settings.mediaProviderTestUnsupported": "该提供商没有可用的轻量验证端点；保存后可用实际生成任务验证。",
  "settings.mediaProviderTestUpstream": "上游服务不可用或返回错误状态 {status}。",
  "settings.mediaProviderTestTimeout": "验证超时。请检查网络、代理或 Base URL。",
  "settings.mediaProviderTestNetwork": "网络错误：{detail}",
  "settings.mediaProviderTestUnknown": "验证失败：{detail}",
  "settings.privacy": "隐私",
  ...
  "settings.privacyContentHint":
    "你发送的 prompt、助手回复、工具输入与工具输出(发送前截断)。API key、token、JWT、邮箱、IP 与信用卡号在发送前会自动剥离。",
  ...
  "entry.discordLabel": "社区支持",
  "entry.discordAria": "打开社区支持",
  "entry.discordAriaWithOnline": "打开社区支持 - {online}",
  "entry.discordOnlineLabel": "{count} 在线",
  "entry.followXLabel": "产品动态",
  "entry.resizeAria": "调整侧边栏宽度",
  "entry.loadingWorkspace": "正在加载工作区…",
  "entry.useEverywhereTitle": "微信连接",
  "entry.useEverywhereAria": "打开微信自动化状态连接",
  "entry.navExpand": "展开侧栏",
  "entry.navCollapse": "收起侧栏",
  "entry.navNewProject": "新建视频项目",
  "entry.navHome": "项目",
  "entry.navProjects": "项目",
  "entry.navTasks": "自动化",
  "entry.navPlugins": "技能",
  "entry.navDesignSystems": "风格预设",
  "entry.navIntegrations": "生成/诊断",
  "workspaceTabs.project": "项目",
  "workspaceTabs.pluginDetails": "插件详情",
  "workspaceTabs.marketplace": "模板市场",
  "marketplace.title": "综合任务模板市场",
  "marketplace.filterAll": "全部模板",
  "marketplace.filterTrusted": "可信",
  "marketplace.filterRestricted": "受限",
  "marketplace.loading": "正在加载模板…",
  "marketplace.empty": "还没有安装电商视频模板。可以从模板源添加剧本、分镜、平台规格或参考视频拆解模板。",
  "marketplace.trustLabel": "信任级别",
  "marketplace.sourcesTitle": "模板源",
  "marketplace.sourcesEmpty": "还没有注册模板源。",
  "marketplace.sourceOfficial": "官方模板源",
  "marketplace.sourceTeam": "团队模板源",
  "marketplace.templateCount": "{count} 个模板",
  "homeHero.title": "开始执行综合任务",
  "homeHero.templatesScrollHint": "向下探索综合任务模板",
  "homeHero.templatesCollapse": "收起模板",
  "homeHero.subtitlePrefix": "视频爬取、素材库分析、脚本分镜、视频生成和诊断复盘集中在一个工作台。",
  "homeHero.placeholder": "粘贴商品、关键词、素材或视频链接，描述你要执行的任务…",
  "homeHero.placeholderActive": "编辑这条任务提示词，或写下你自己的综合工作流需求…",
  "homeHero.skills": "技能",
  "homeHero.addMenu": "添加",
  ...
  "homeHero.searchPrompt": "搜索文件、创作工作流、技能、MCP 服务器和连接器。",
  ...
  "homeHero.chip.image": "商品素材",
  "homeHero.chip.video": "带货视频",
  "homeHero.chip.hyperframes": "分镜动效",
  "homeHero.chip.audio": "配音/字幕",
  "homeHero.chip.createPlugin": "创建插件",
  "homeHero.chip.figma": "来自 Figma",
  "homeHero.chip.folder": "来自文件夹",
  "homeHero.chip.template": "任务模板",
  "homeHero.chip.liveArtifactHint": "构建可实时预览的交互式 HTML/CSS/JS 制品。",
  "homeHero.chip.hyperframesHint": "规划镜头结构、字幕层级、转场与移动端安全动效。",
  ...
  "homeHero.chip.templateHint": "浏览视频爬取、素材分析、脚本分镜、生成和诊断模板。",
  ...
  "pluginsHome.title": "综合任务模板库",
  "pluginsHome.subtitle": "视频爬取、素材库分析、脚本分镜、视频生成、诊断复盘的常用任务模板。",
  "pluginsHome.browseRegistry": "打开模板市场",
  "pluginsHome.count": "{filtered} / {total}",
  "pluginsHome.loadingCatalog": "正在加载模板…",
  "pluginsHome.emptyCatalog": "暂时没有可用的综合任务模板。媒体生成底座已保留，下一步可以继续接入模板包。",
  "pluginsHome.emptyFiltered": "没有模板匹配当前筛选条件。",
  "pluginsHome.clearFilters": "清除筛选",
  "pluginsHome.modeAria": "模板模式",
  "pluginsHome.featured": "已保存",
  "pluginsHome.totalInCatalog": "共 {n} 个模板",
  "pluginsHome.categoryFilterAria": "模板类别筛选",
  "pluginsHome.subcategoryFilterAria": "{label} 子类别筛选",
  "pluginsHome.allCategory": "全部 {label}",
  "pluginsHome.searchPlaceholder": "搜索任务模板…",
  "pluginsHome.searchAria": "搜索综合任务模板",
  ...
  "pluginsHome.facet.videoHooks": "开场钩子",
  "pluginsHome.facet.videoProductDemo": "商品演示",
  "pluginsHome.facet.videoPlatformShorts": "平台短视频",
  "pluginsHome.facet.videoReferenceBreakdown": "参考拆解",
  "pluginsHome.facet.imageProductAssets": "商品素材",
  "pluginsHome.facet.imageLifestyleScenes": "生活方式场景",
  "pluginsHome.facet.imageBeforeAfter": "前后对比",
  "pluginsHome.facet.hyperframesStoryboards": "分镜",
  "pluginsHome.facet.hyperframesCaptions": "字幕",
  "pluginsHome.facet.hyperframesTransitions": "转场",
  "pluginsHome.facet.audioVoiceover": "旁白",
  "pluginsHome.facet.audioCaptionTiming": "字幕时间轴",
  "pluginsHome.facet.audioSonicBrand": "声音品牌",
  ...
  "integrations.tabHint.useEverywhere": "微信状态",
  ...
  "useEverywhere.modalAria": "连接微信自动化状态",
  "useEverywhere.modalTitle": "微信 Agent 连接",
  "useEverywhere.modalSubtitle":
    "连接微信到内置 Agent 后，可在微信里询问定时智能体会话、自动化、Orbit 摘要和实时看板状态。",
  "useEverywhere.closeAria": "关闭微信连接",
  "useEverywhere.closeTitle": "关闭 (Esc)",
  "useEverywhere.tabsAria": "微信状态入口",
  "useEverywhere.footStrong": "微信状态入口。",
  "useEverywhere.footBody": "备用说明只用于把微信网关接入 Open Design 内置 Agent 桥，不再展示旧的随处使用指南。",
  "useEverywhere.configureMcp": "查看自动化",
  "useEverywhere.copyGuide": "复制备用接入说明",
  ...
  "useEverywhere.section.overview.heading": "连接微信到内置 Agent",
  "useEverywhere.section.overview.intro":
    "把微信入口接到 Open Design 已连接的内置 Agent（如 OpenCode）后，就能在聊天里询问 Open Design 自动化状态。",
  "useEverywhere.section.overview.bullet1": "优先复用 Open Design 已连接的 Agent，不要求用户额外安装外部通道 CLI。",
  "useEverywhere.section.overview.bullet2": "自动化运行状态",
  "useEverywhere.section.overview.bullet3": "Orbit 摘要进度",
  "useEverywhere.section.overview.bullet4": "实时看板新鲜度",
  "useEverywhere.section.overview.bullet5": "先把微信保持为只读状态入口；桥接可信后，再逐步加入触发控制。",
  "useEverywhere.section.overview.snippet1": "连接内置 Agent 桥",
  "useEverywhere.section.overview.snippet2": "Open Design 状态读取入口",
  "useEverywhere.section.overview.snippet3": "微信问题和回复结构",
  "useEverywhere.section.overview.footer":
    "Open Design 不会保存微信凭据。微信认证由网关负责；Open Design 这里只暴露内置 Agent 桥和只读状态入口。",
  ...
  "newproj.tabDeck": "幻灯片",
  "newproj.tabTemplate": "模板",
  "newproj.tabMedia": "视频工作流",
  "newproj.tabOther": "自定义",
  "newproj.titlePrototype": "新建原型",
  "newproj.titleLiveArtifact": "新建实时看板",
  "newproj.titleDeck": "新建幻灯片",
  "newproj.titleTemplate": "从电商视频模板开始",
  "newproj.titleImage": "新建商品素材",
  "newproj.titleVideo": "新建带货视频",
  "newproj.titleAudio": "新建配音/字幕",
  "newproj.titleMedia": "新建视频工作流",
  "newproj.titleOther": "新建自定义视频项目",
  ...
  "newproj.surfaceImage": "商品素材",
  "newproj.surfaceVideo": "带货视频",
  "newproj.surfaceAudio": "配音/字幕",
  ...
  "chat.mode.comprehensive.label": "综合",
  "chat.mode.comprehensive.title": "综合工作台模式",
  "chat.mode.comprehensive.summary": "适合由 agent 串联视频爬取、素材库分析、脚本分镜、媒体生成和诊断复盘的完整任务。",
  "chat.mode.comprehensive.solves":
    "当任务需要 agent 自己判断该用哪些后台接口、连接器和 skill，而不是进入单一问答或设计简报时使用。",
  "chat.mode.comprehensive.query1": "爬取公开视频样本，筛选后只把有价值的带货参考加入素材库。",
  "chat.mode.comprehensive.query2": "解析当前视频素材，提取可复用的分镜结构和方法论。",
  "chat.mode.comprehensive.query3": "基于素材、脚本、分镜和质检门槛生成一条产品视频流水线。",
  ...
  "chat.example1Prompt":
    "下一步：请基于我提供的商品图片 / 视频，先识别商品品类、核心卖点、适合人群和素材质量，并输出一份 15 秒 AIGC 带货视频生成方案。包含镜头结构、开场钩子、口播方向、画面节奏和需要补充的素材清单。",
  "chat.example2Title": "生成带货脚本",
  "chat.example2Tag": "卖点脚本",
  "chat.example2Prompt":
    "下一步：为这款商品生成 3 条适合短视频平台的带货脚本，每条 15-30 秒。请按痛点开场、卖点证明、使用场景、优惠引导和行动召唤组织，并给出画面提示词、口播文案和字幕节奏。",
  "chat.example3Title": "批量产出视频",
  "chat.example3Tag": "成片入库",
  "chat.example3Prompt":
    "下一步：根据已有商品素材批量生成 AIGC 带货视频任务清单。请把每个商品拆成主图素材、卖点短片、口播脚本、封面标题、切片策略和入库标签，并标注优先级与缺失信息。",
  ...
  "assistant.feedbackReasonNote": "补充一句说明，帮助工作台判断哪一步视频生成做对了、下一轮该改哪里。",
  ...
  "pet.composerMenuHint": "当前工作台已隐藏同伴控件。",
  ...
  "pet.codexEmpty": "当前裁剪版工作台没有可用的同伴素材。",
  ...
  "automations.eyebrow": "视频工作流",
  "automations.title": "自动化",
  "automations.lede": "为带货视频素材、类目探索、剧本、分镜、生成诊断和效果复盘安排周期性会话。",
  ...
  "automations.emptyBody": "从视频工作流模板创建一个，或从空白计划开始。",
  ...
  "automations.templatesTitle": "视频工作流模板",
  "automations.templatesSub":
    "只保留带货视频生产会用到的周期任务：素材、类目爬虫探索、爬视频入库、剧本、分镜、生成诊断和效果复盘。",
  ...
  "automations.templatesEmptyBody": "换一个视频环节筛选，或从空白自动化开始。",
  ...
  "automations.filterMemory": "素材",
  "automations.filterCrawler": "爬虫",
  "automations.filterDesignSystems": "剧本",
  "automations.filterSkills": "分镜",
  "automations.filterConnectors": "生成/诊断",
  "automations.filterCompression": "压缩",
  "automations.filterRelease": "发布",
  "automations.filterQuality": "复盘",
  "automations.tpl.memoryRefresh.title": "素材齐套巡检",
  "automations.tpl.memoryRefresh.desc": "检查商品图、卖点、品牌约束、参考视频和平台规格是否齐全，输出缺口清单。",
  "automations.tpl.memoryRefresh.prompt":
    "围绕当前项目检查带货视频素材是否齐套：商品图片或视频、卖点、价格权益、品牌语气、参考视频、平台规格、禁用词和授权信息。输出已就绪、缺失、风险、下一步补齐动作，并标记是否可进入脚本阶段。",
  "automations.tpl.categoryCrawler.title": "类目带货视频探索",
  "automations.tpl.categoryCrawler.desc": "定期爬取并拆解某一类目带货视频，沉淀可复用流水线模板。",
  "automations.tpl.categoryCrawler.prompt":
    "围绕一个指定商品类目或关键词，使用可用搜索/爬虫连接器收集近期带货视频案例。按平台、账号类型、开场钩子、商品呈现、镜头结构、口播卖点、字幕节奏、音效、CTA、互动数据和评论反馈拆解共性。输出：1）样本清单与来源；2）爆款结构模式；3）可复用脚本/分镜/生成提示词流水线；4）建议沉淀到 skill 或 DESIGN.md 的模板片段；5）下一轮需要补充的数据。",
  "automations.tpl.videoAssetCrawler.title": "爬视频入素材库",
  "automations.tpl.videoAssetCrawler.desc":
    "搜索带货视频候选，筛选可用参考视频，导入 commerce video 素材库并验证入库结果。",
  "automations.tpl.videoAssetCrawler.prompt":
    "围绕指定商品、类目、平台或关键词，使用可用视频搜索/爬虫连接器寻找公开带货视频候选。先由 agent 判断哪些视频真正适合做参考素材，再把入选视频加入 commerce video 素材库。优先使用后端素材库 CLI：`od assets commerce-videos search --connector bilibili --query <关键词> --limit 20 --sort hot --json`；逐条筛选后用 `od assets commerce-videos import --title <标题> --connector bilibili --source-url <url> --source-video-id <平台视频 id> --subject <商品或关键词> --category 带货视频样本 --summary <选择理由> --json` 写入素材库；需要立即下载视频文件时使用 `od assets commerce-videos import-crawler --connector bilibili --url <url> --json`，本地公开 Bilibili 测试路径可追加 `--public-test --resolution 360p`。导入后用 `od assets commerce-videos list --query <关键词> --json` 验证，并输出已导入素材 ID、跳过原因和连接器/授权缺口。",
  "automations.tpl.designSystemRefresh.title": "带货脚本优化",
  "automations.tpl.designSystemRefresh.desc": "按平台、时长和转化目标重写钩子、卖点、口播与 CTA。",
  "automations.tpl.designSystemRefresh.prompt":
    "基于当前商品资料、目标平台和视频时长优化带货脚本。输出 3 个开场钩子、精简卖点结构、口播稿、字幕节奏、CTA 和风险提示，优先保证可生成、可剪辑、可转化。",
  "automations.tpl.liveArtifactRegistry.title": "分镜与镜头清单",
  "automations.tpl.liveArtifactRegistry.desc": "把脚本拆成镜头、画面素材、字幕、音效和生成提示词。",
  "automations.tpl.liveArtifactRegistry.prompt":
    "把当前脚本拆成带货视频分镜。为每个镜头给出时长、画面目标、需要的商品素材、字幕、口播、音效或音乐、图片/视频生成提示词和质检要点，并指出缺失素材。",
  "automations.tpl.orbitDashboard.title": "生成失败诊断",
  "automations.tpl.orbitDashboard.desc": "汇总最近生成记录、媒体配置和错误信息，给出可执行修复建议。",
  "automations.tpl.orbitDashboard.prompt":
    "检查当前项目最近的图片、视频、音频生成结果和错误信息。定位失败原因，区分素材缺失、提示词不清、模型配置、额度或网络问题，输出可执行的重试方案和需要用户补充的信息。",
  "automations.tpl.releaseNotes.title": "根据已交付的设计工作起草发布说明。",
  "automations.tpl.releaseNotes.desc": "把已合并的 PR、制品和面向产品的改动整合成发布说明。",
  "automations.tpl.qualityRegressionWatch.title": "视频效果复盘",
  "automations.tpl.qualityRegressionWatch.desc": "复盘完播、点击、转化和评论反馈，沉淀下一版脚本/素材调整。",
  "automations.tpl.qualityRegressionWatch.prompt":
    "复盘当前带货视频的表现数据和人工反馈。围绕完播、点击、转化、评论、画面吸引力和卖点清晰度总结问题，输出下一版脚本、素材、分镜和生成参数的调整建议。",
